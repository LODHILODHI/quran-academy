  ...
  return (
    <>
      ...
      <main>
        ...
        {/* About Details End */}
        {/* Count Down Start */}
        <div className="count-down-area pt-90 pb-60 section-bg" style={{backgroundImage: "url('/assets/img/gallery/section_bg01.png')"}}>
            <div className="container">
                <div className="row justify-content-center">
